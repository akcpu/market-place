exports.appConfig = {
  ...
  VerifyType: process.env.VerifyType,
  ...
  // recaptchaSiteKey: decodeBase64(process.env.recaptchaSiteKey), //reCAPTCHA type:v3 - in the HTML code your site serves to users
  // recaptchaSecretKey: decodeBase64(process.env.recaptchaSecretKey), //reCAPTCHA type:v3 - for communication between your site and reCAPTCHA
